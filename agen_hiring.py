...
def set_light_blue_theme():
    st.markdown("""
        ...
        * {
        ...
        /* Force sticky tabs */
        section.main > div > div > div > div[data-testid="stTabs"] {
